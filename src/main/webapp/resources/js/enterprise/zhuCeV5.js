...
//		}
		...
		validateArray.push($("#enterpriseReplenishInfo"));
	...
	$("#partnerDiv1").append("<div class=\"box1\"><p class=\"title\">单位股东：</p>" +
		...
		"<div class=\"show_box\">"+
			"<div class=\"show\" style=\"margin-bottom: 10px;\" >"+
				"<label>法定代表人：</label>"+
				"<input type=\"text\" class=\"w_text_100\" placeholder=\"法定代表人\" data-validate=\"required:true;\"  id=\"legalPerson\"  data-info=\"partnerInfo:ext\" />"+
				"<label>公司名称：</label>"+
				"<input type=\"text\" class=\"w_text_130\" placeholder=\"公司名称\" data-validate=\"required:true;\"  id=\"name\" data-info=\"partnerInfo:main\" />"+
				"<label>营业执照号码：</label>"+
